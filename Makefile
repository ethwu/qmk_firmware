...
ifndef SKIP_GIT
	...
	if [ ! -e lib/vusb ]; then git submodule sync lib/vusb && git submodule update --depth 1 --init lib/vusb; fi
	if [ ! -e lib/printf ]; then git submodule sync lib/printf && git submodule update --depth 1 --init lib/printf; fi
