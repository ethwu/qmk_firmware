...
C(KC_F4),	G(KC_Q),	G(KC_W),	XXXXXXX,	G(S(KC_Z)),	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_VOLD,	KC_VOLU,	KC_MUTE,	XXXXXXX,
FN_CTRL,	XXXXXXX,	G(KC_S),	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_BRID,	KC_BRIU,	_______,	        	XXXXXXX,
_______,	G(KC_Z),	G(KC_X),	G(KC_C),	G(KC_V),	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_MPRV,	KC_MNXT,	KC_MPLY,	_______,	        	_______,	XXXXXXX,
